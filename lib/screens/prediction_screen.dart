        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(child: _buildTextField('Distance (m)', '20', (val) => _distance = double.parse(val))),
                  const SizedBox(width: 16),
                  Expanded(child: _buildTextField('Height (m)', '1.5', (val) => _height = double.parse(val))),
                ],
              ),
              const SizedBox(height: 20),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text(
              '* Note: This prediction is generated by your local Random Forest model.',
